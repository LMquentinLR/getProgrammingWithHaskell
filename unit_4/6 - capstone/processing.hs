...
-- the file ohsu_ncnm_wscc_bibs.mrc needs to be downloaded from the following link:
-- https://archive.org/download/marc_oregon_summit_records/catalog_files/
-- place it in the same folder as this .hs file
...
main = do
  ...
  TIO.writeFile "books_oregon.html" processed
  putStrLn "All Done!"